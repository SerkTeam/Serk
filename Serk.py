...
helpMessage =""" ~S͟͟͟͞͞͞E͟͟͟͞͞͞R͟͟͟͞͞͞K͟͟͟͞͞͞*T͟͟͟͞͞͞E͟͟͟͞͞͞A͟͟͟͞͞͞M͟͟͟͞͞͞~
「Info Bots :」
>> Creator Bot By 
                 ™RadenRamadhan™ 
                    ™MiLLove™ 
...
>> Guest On = Pertahankan grup
>> Mad On   = Pertahankan grup
>> Vk @    = Untuk kick seseorang
...
Bots=[mid]
admin=["ucbd1374cb68242824dc21abcd7d6f669"]
creator=["u3fa0c0964985cd663d1fce84507e9b9b"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 17:
                ...
                cb = Message()
                cb.to = op.param1
                cb.text = "Hallo " + cl.getContact(op.param2).displayName + ". Wellcome To " + group.name + ". Silahkan Patuhi Peraturan & Jangan Nakal Ya!!!!"
                random.choice(KAC).sendMessage(cb)
        if op.type == 15:
            if op.param2 in Bots:
                return
            ki.sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName  +  "Good Bye" + "Semoga tenang disana")
            print "MemberLeft"
        if op.type == 13:
            if op.param3 in mid:
...
#-----------------------------------------------
            elif msg.text in ["Cipok semuanya","Tagall"]:
              if msg.from_ in admin:
...
#-----------------------------------------------
            ...
            elif msg.text in ["Serk join","Masuk say"]:
				if msg.from_ in admin:
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*1͠ On")
					ki.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*2 On")
					kk.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*3 On")
					ky.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*4 On")
                    k1.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*5 On")
#-----------------------------------------------
...
#-----------------------------------------------
        ...
        #-------------Fungsi Spam Start---------------------#
                ...
                ky.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                ki.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                kk.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                k1.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                ky.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                ki.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                kk.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                k1.sendText(msg.to,"􀔃􀆶squared up!􏿿")
                ...
                if msg.from_ in creator:
                    ...
                    if gid == "":
                        ...
                        try:
                            ...
                            cl.sendText(msg.to,"Aku ga disitu bos")
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                cl.sendText(msg.to,"Hadir Semua Bos")
#-----------------------------------------------
				...
				if msg.from_ in admin:
					...
					ky.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*4 Ready")
					kl.sendText(msg.to,"S͠E͠R͠K͠*B͠O͠T͠*5 Ready")
#-----------------------------------------------
	    elif msg.text in ["Set"]:
		 if msg.toType == 2:
...
#-----------------------------------------------
            ...
            elif msg.text in ["Serk Sp","All Sp"]:
				if msg.from_ in creator:
					start = time.time()
					cl.sendText(msg.to, "Wait...")
					elapsed_time = time.time() - start
			...
			for zx in range(0,100):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						ky.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ™RadenRamadhan™ \n\nLike Like LIke\nId: line://line.me/R/ti/p/%40fss0252j")	
						kl.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ™RadenRamadhan™ \n\nLike Like LIke\nId: line://ti/p/~rd.rmdhn")	
						print "DiLike"
					except:
							pass
				else:
